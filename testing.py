...
links = [
    ...
    Link(6, 48626, 1333975127.0, 63,
         ...
         "http://arstechnica.com/business/news/2012/04/an-in-depth-look-at-qt-5-making-javascript-a"
         "-first-class-citizen-for-native-cross-platform-developme.ars"),
...
def build_link_index():
    return {var.id: var for var in links}
...
new_link = (93, 477882, 1333934004.0, 90, "Cheese is funky! :D",
            "http://www.r-bloggers.com/an-r-programmer-looks-at-julia/")
add_new_link(new_link)

for key, val in link_index.items():
    print key, '-->', val